...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const products = [
        ...
        { id: 4, name: 'Strawnana x Gusher', titleImageUrl: 'https://placehold.co/300x80/0F141E/FFFFFF?text=Strawnana', category: 'Plasma Static', farm: 'CH3', videoUrl: 'https://test-videos.co.uk/vids/bigbuckbunny/mp4/h264/360/Big_Buck_Bunny_360_10s_1MB.mp4', videoThumbnailUrl: 'https://placehold.co/600x400/2c3e50/ecf0f1?text=Strawnana+x+Gusher', description: 'Description détaillée pour Strawnana x Gusher.<br>👃 Terpènes :<br>😋 Goût :', prices: { '3g': 45, '5g': 70, '10g': 130 } },
